A machine learning web application that predicts whether a person is at risk of diabetes based on key health indicators. Built with Python, trained in Google Colab.
📊 Overview
